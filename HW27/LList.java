...
//2018-03-28
 ...
 public class LList<T> implements List<T>
 {
   ...
   public Iterator<T> iterator(){
     MyIterator beep = new MyIterator();
     return beep;
   }
      ...
      public class MyIterator implements Iterator<T>
   {
     ...
     //removes last element returned by this iterator (from last next() call)
     ...
     public void remove()
     {
       ...
       /* "Follow your inner moonlight; don't hide the madness."
 	    ...
 	    //if you are removing the last element...
       ...
       //
        ...
        DLLNode<T> nextNode= (DLLNode)next();
        _dummy.setNext(nextNode.getNext());
        nextNode.getNext().setPrev(_dummy);
        _okToRemove=false;
 	    }
